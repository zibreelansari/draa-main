/**
 * Teacher Blog Routes
 * Same shape as studentBlogRoutes but guarded by the teacher auth middleware.
 * All controller logic is shared — StudentBlogController is role-aware.
 */
...
const teacherAuthMiddleware = require("../Middlewares/teacher.auth.middleware");
