...
// --- SVG ICONS (DITTO) ---
export const Icons: Record<string, (size?: number, color?: string) => React.ReactNode> = {
...
// Add your global CSS style block here as a string or export it to a .css file
export const DashboardGlobalStyles = `
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');
  :root {
    --ink: #0d0c1d; --ink2: #4b4966; --ink3: #9896b8; --surface: #ffffff; --surface2: #f5f4ff;
    --edge: rgba(94,107,255,0.1); --edge2: #e8e7f8; --accent: #6366f1; --accent2: #5E6BFF;
    --accent-bg: rgba(94,107,255,0.07); --sh: 0 1px 3px rgba(13,12,29,.05), 0 4px 16px rgba(94,107,255,.07);
    --sh2: 0 4px 24px rgba(94,107,255,.13), 0 1px 4px rgba(13,12,29,.07); --sidebar: 252px; --header: 60px;
    --font:'Inter', system-ui, -apple-system, BlinkMacSystemFont,'Segoe UI', Roboto, sans-serif; /* --display removed */
  }
  .sidebar { width:var(--sidebar); height:100vh; position:sticky; top:0; background:var(--surface); border-right:1px solid var(--edge2); transition: width 0.2s; overflow: hidden; }
  .sidebar.closed { width:0; }
  .dropdown-item { display:flex; alignItems:center; gap:9; padding:10px 14px; font-size:13px; font-weight:500; color:var(--ink); cursor:pointer; }
  .dropdown-item:hover { background: var(--surface2); }
  /* ... copy rest of your original CSS here ... */
`;