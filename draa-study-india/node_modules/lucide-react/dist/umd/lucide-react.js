...
(function (global, factory) {
  ...
  const AlignEndHorizontal = createLucideIcon("AlignEndHorizontal", __iconNode$o3);
  ...
  const AlignEndVertical = createLucideIcon("AlignEndVertical", __iconNode$o2);
  ...
  const AlignVerticalDistributeCenter = createLucideIcon("AlignVerticalDistributeCenter", __iconNode$nR);
  ...
  const AlignStartVertical = createLucideIcon("AlignStartVertical", __iconNode$nQ);
  ...
  const ArrowDownUp = createLucideIcon("ArrowDownUp", __iconNode$nb);
  ...
  const ArrowDownToLine = createLucideIcon("ArrowDownToLine", __iconNode$na);
  ...
  const ArrowLeftToLine = createLucideIcon("ArrowLeftToLine", __iconNode$n5);
  ...
  const ArrowLeftRight = createLucideIcon("ArrowLeftRight", __iconNode$n4);
  ...
  const ArrowUpFromLine = createLucideIcon("ArrowUpFromLine", __iconNode$mW);
  ...
  const ArrowUpFromDot = createLucideIcon("ArrowUpFromDot", __iconNode$mV);
  ...
  const BadgeMinus = createLucideIcon("BadgeMinus", __iconNode$mu);
  ...
  const BadgeJapaneseYen = createLucideIcon("BadgeJapaneseYen", __iconNode$mt);
  ...
  const BadgePoundSterling = createLucideIcon("BadgePoundSterling", __iconNode$mr);
  ...
  const BadgePlus = createLucideIcon("BadgePlus", __iconNode$mq);
  ...
  const Baseline = createLucideIcon("Baseline", __iconNode$mg);
  ...
  const Barcode = createLucideIcon("Barcode", __iconNode$mf);
  ...
  const Bath = createLucideIcon("Bath", __iconNode$me);
  ...
  const Battery = createLucideIcon("Battery", __iconNode$m7);
  ...
  const Beaker = createLucideIcon("Beaker", __iconNode$m6);
  ...
  const Binoculars = createLucideIcon("Binoculars", __iconNode$lM);
  ...
  const Binary = createLucideIcon("Binary", __iconNode$lL);
  ...
  const BookCheck = createLucideIcon("BookCheck", __iconNode$lu);
  ...
  const BookCopy = createLucideIcon("BookCopy", __iconNode$lt);
  ...
  const BookX = createLucideIcon("BookX", __iconNode$lb);
  ...
  const BookUser = createLucideIcon("BookUser", __iconNode$la);

  const __iconNode$l9 = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z", key: "169p4p" }],
    ["path", { d: "m9 10 2 2 4-4", key: "1gnqz4" }]
  ];
  const BookmarkCheck = createLucideIcon("BookmarkCheck", __iconNode$l9);
  ...
  const Book = createLucideIcon("Book", __iconNode$l8);
  ...
  const Bookmark = createLucideIcon("Bookmark", __iconNode$l5);
  ...
  const BookmarkX = createLucideIcon("BookmarkX", __iconNode$l4);
  ...
  const BriefcaseMedical = createLucideIcon("BriefcaseMedical", __iconNode$kR);

  const __iconNode$kQ = [
    ["path", { d: "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16", key: "jecpp" }],
    ["rect", { width: "20", height: "14", x: "2", y: "6", rx: "2", key: "i6l2r4" }]
  ];
  const Briefcase = createLucideIcon("Briefcase", __iconNode$kQ);
  ...
  const BusFront = createLucideIcon("BusFront", __iconNode$kJ);
  ...
  const Bus = createLucideIcon("Bus", __iconNode$kI);
  ...
  const Building = createLucideIcon("Building", __iconNode$kH);
  ...
  const CalendarMinus2 = createLucideIcon("CalendarMinus2", __iconNode$ks);
  ...
  const CalendarHeart = createLucideIcon("CalendarHeart", __iconNode$kr);
  ...
  const CalendarSync = createLucideIcon("CalendarSync", __iconNode$kl);
  ...
  const CalendarSearch = createLucideIcon("CalendarSearch", __iconNode$kk);
  ...
  const CarTaxiFront = createLucideIcon("CarTaxiFront", __iconNode$k7);
  ...
  const Car = createLucideIcon("Car", __iconNode$k6);
  ...
  const ChartColumnDecreasing = createLucideIcon("ChartColumnDecreasing", __iconNode$jP);
  ...
  const ChartColumnIncreasing = createLucideIcon("ChartColumnIncreasing", __iconNode$jO);
  ...
  const ChevronLast = createLucideIcon("ChevronLast", __iconNode$jv);

  const __iconNode$ju = [
    ["path", { d: "m17 18-6-6 6-6", key: "1yerx2" }],
    ["path", { d: "M7 6v12", key: "1p53r6" }]
  ];
  const ChevronFirst = createLucideIcon("ChevronFirst", __iconNode$ju);
  ...
  const CircleArrowOutDownLeft = createLucideIcon("CircleArrowOutDownLeft", __iconNode$ja);
  ...
  const CircleArrowOutDownRight = createLucideIcon("CircleArrowOutDownRight", __iconNode$j9);
  ...
  const CircleChevronRight = createLucideIcon("CircleChevronRight", __iconNode$j1);

  const __iconNode$j0 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const CircleChevronLeft = createLucideIcon("CircleChevronLeft", __iconNode$j0);

  const __iconNode$i$ = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const CircleChevronUp = createLucideIcon("CircleChevronUp", __iconNode$i$);
  ...
  const CircleDashed = createLucideIcon("CircleDashed", __iconNode$i_);
  ...
  const ClipboardPlus = createLucideIcon("ClipboardPlus", __iconNode$ip);
  ...
  const ClipboardPen = createLucideIcon("ClipboardPen", __iconNode$io);
  ...
  const CloudHail = createLucideIcon("CloudHail", __iconNode$i0);
  ...
  const CloudFog = createLucideIcon("CloudFog", __iconNode$h$);
  ...
  const Cloudy = createLucideIcon("Cloudy", __iconNode$hQ);

  const __iconNode$hP = [
    ["path", { d: "M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z", key: "p7xjir" }]
  ];
  const Cloud = createLucideIcon("Cloud", __iconNode$hP);
  ...
  const Club = createLucideIcon("Club", __iconNode$hO);
  ...
  const CodeXml = createLucideIcon("CodeXml", __iconNode$hN);
  ...
  const Clover = createLucideIcon("Clover", __iconNode$hM);
  ...
  const Command = createLucideIcon("Command", __iconNode$hB);
  ...
  const Component = createLucideIcon("Component", __iconNode$hA);
  ...
  const CopySlash = createLucideIcon("CopySlash", __iconNode$hm);
  ...
  const CopyPlus = createLucideIcon("CopyPlus", __iconNode$hl);
  ...
  const Cpu = createLucideIcon("Cpu", __iconNode$h8);
  ...
  const CreativeCommons = createLucideIcon("CreativeCommons", __iconNode$h7);
  ...
  const Crop = createLucideIcon("Crop", __iconNode$h4);
  ...
  const Cross = createLucideIcon("Cross", __iconNode$h3);
  ...
  const Dice3 = createLucideIcon("Dice3", __iconNode$gM);
  ...
  const Dice2 = createLucideIcon("Dice2", __iconNode$gL);
  ...
  const EarOff = createLucideIcon("EarOff", __iconNode$gh);
  ...
  const Eraser = createLucideIcon("Eraser", __iconNode$g3);
  ...
  const EthernetPort = createLucideIcon("EthernetPort", __iconNode$g2);
  ...
  const Factory = createLucideIcon("Factory", __iconNode$fX);
  ...
  const Facebook = createLucideIcon("Facebook", __iconNode$fW);
  ...
  const FileLock = createLucideIcon("FileLock", __iconNode$fn);
  ...
  const FileMinus2 = createLucideIcon("FileMinus2", __iconNode$fm);
  ...
  const FileSearch2 = createLucideIcon("FileSearch2", __iconNode$fd);
  ...
  const FileScan = createLucideIcon("FileScan", __iconNode$fc);
  ...
  const FilterX = createLucideIcon("FilterX", __iconNode$eT);
  ...
  const Film = createLucideIcon("Film", __iconNode$eS);
  ...
  const FlameKindling = createLucideIcon("FlameKindling", __iconNode$eI);
  ...
  const Flame = createLucideIcon("Flame", __iconNode$eH);

  const __iconNode$eG = [
    ["path", { d: "M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z", key: "i9b6wo" }],
    ["line", { x1: "4", x2: "4", y1: "22", y2: "15", key: "1cm3nv" }]
  ];
  const Flag = createLucideIcon("Flag", __iconNode$eG);
  ...
  const FlaskRound = createLucideIcon("FlaskRound", __iconNode$eC);
  ...
  const FlaskConical = createLucideIcon("FlaskConical", __iconNode$eB);
  ...
  const Flower = createLucideIcon("Flower", __iconNode$ew);
  ...
  const Flower2 = createLucideIcon("Flower2", __iconNode$ev);
  ...
  const Focus = createLucideIcon("Focus", __iconNode$eu);
  ...
  const FolderPlus = createLucideIcon("FolderPlus", __iconNode$e8);
  ...
  const FolderPen = createLucideIcon("FolderPen", __iconNode$e7);
  ...
  const FolderSearch = createLucideIcon("FolderSearch", __iconNode$e4);
  ...
  const FolderSymlink = createLucideIcon("FolderSymlink", __iconNode$e3);
  ...
  const FolderTree = createLucideIcon("FolderTree", __iconNode$e2);
  ...
  const FolderSync = createLucideIcon("FolderSync", __iconNode$e1);
  ...
  const Framer = createLucideIcon("Framer", __iconNode$dV);
  ...
  const Frame = createLucideIcon("Frame", __iconNode$dU);
  ...
  const GalleryHorizontalEnd = createLucideIcon("GalleryHorizontalEnd", __iconNode$dR);
  ...
  const Fullscreen = createLucideIcon("Fullscreen", __iconNode$dQ);
  ...
  const GalleryThumbnails = createLucideIcon("GalleryThumbnails", __iconNode$dP);
  ...
  const GalleryHorizontal = createLucideIcon("GalleryHorizontal", __iconNode$dO);
  ...
  const GitBranchPlus = createLucideIcon("GitBranchPlus", __iconNode$dE);
  ...
  const GitBranch = createLucideIcon("GitBranch", __iconNode$dD);
  ...
  const GitCommitHorizontal = createLucideIcon("GitCommitHorizontal", __iconNode$dC);
  ...
  const GitPullRequestClosed = createLucideIcon("GitPullRequestClosed", __iconNode$dv);
  ...
  const GitPullRequestArrow = createLucideIcon("GitPullRequestArrow", __iconNode$du);
  ...
  const GitPullRequestCreate = createLucideIcon("GitPullRequestCreate", __iconNode$dt);
  ...
  const GitPullRequestCreateArrow = createLucideIcon("GitPullRequestCreateArrow", __iconNode$ds);
  ...
  const GlassWater = createLucideIcon("GlassWater", __iconNode$dn);
  ...
  const Grid2x2Check = createLucideIcon("Grid2x2Check", __iconNode$dg);
  ...
  const Grid2x2Plus = createLucideIcon("Grid2x2Plus", __iconNode$de);
  ...
  const HardDriveUpload = createLucideIcon("HardDriveUpload", __iconNode$cY);
  ...
  const HardDriveDownload = createLucideIcon("HardDriveDownload", __iconNode$cX);
  ...
  const Highlighter = createLucideIcon("Highlighter", __iconNode$cA);
  ...
  const Hospital = createLucideIcon("Hospital", __iconNode$cx);
  ...
  const ListFilter = createLucideIcon("ListFilter", __iconNode$be);
  ...
  const ListMinus = createLucideIcon("ListMinus", __iconNode$bd);
  ...
  const ListTree = createLucideIcon("ListTree", __iconNode$b6);
  ...
  const ListVideo = createLucideIcon("ListVideo", __iconNode$b5);
  ...
  const Mails = createLucideIcon("Mails", __iconNode$aE);
  ...
  const MapPinCheckInside = createLucideIcon("MapPinCheckInside", __iconNode$aD);
  ...
  const Map = createLucideIcon("Map", __iconNode$ar);
  ...
  const MapPlus = createLucideIcon("MapPlus", __iconNode$aq);
  ...
  const MessageCircleOff = createLucideIcon("MessageCircleOff", __iconNode$a9);
  ...
  const MessageCirclePlus = createLucideIcon("MessageCirclePlus", __iconNode$a8);
  ...
  const MessageCircleWarning = createLucideIcon("MessageCircleWarning", __iconNode$a5);
  ...
  const MessageCircleX = createLucideIcon("MessageCircleX", __iconNode$a4);

  const __iconNode$a3 = [
    ["path", { d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z", key: "vv11sd" }]
  ];
  const MessageCircle = createLucideIcon("MessageCircle", __iconNode$a3);
  ...
  const MessageSquare = createLucideIcon("MessageSquare", __iconNode$9Q);
  ...
  const MessagesSquare = createLucideIcon("MessagesSquare", __iconNode$9P);
  ...
  const MessageSquareX = createLucideIcon("MessageSquareX", __iconNode$9O);
  ...
  const Milk = createLucideIcon("Milk", __iconNode$9G);
  ...
  const MilkOff = createLucideIcon("MilkOff", __iconNode$9F);
  ...
  const __iconNode$9D = [["path", { d: "M5 12h14", key: "1ays0h" }]];
  const Minus = createLucideIcon("Minus", __iconNode$9D);
  ...
  const Minimize = createLucideIcon("Minimize", __iconNode$9C);
  ...
  const Moon = createLucideIcon("Moon", __iconNode$9n);
  ...
  const MountainSnow = createLucideIcon("MountainSnow", __iconNode$9m);
  ...
  const MousePointer = createLucideIcon("MousePointer", __iconNode$9g);

  const __iconNode$9f = [
    ["rect", { x: "5", y: "2", width: "14", height: "20", rx: "7", key: "11ol66" }],
    ["path", { d: "M12 6v4", key: "16clxf" }]
  ];
  const Mouse = createLucideIcon("Mouse", __iconNode$9f);
  ...
  const MoveHorizontal = createLucideIcon("MoveHorizontal", __iconNode$98);

  const __iconNode$97 = [
    ["path", { d: "M6 8L2 12L6 16", key: "kyvwex" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveLeft = createLucideIcon("MoveLeft", __iconNode$97);
  ...
  const NonBinary = createLucideIcon("NonBinary", __iconNode$8R);
  ...
  const NotebookPen = createLucideIcon("NotebookPen", __iconNode$8Q);
  ...
  const PanelTopDashed = createLucideIcon("PanelTopDashed", __iconNode$8a);
  ...
  const PanelTopClose = createLucideIcon("PanelTopClose", __iconNode$89);
  ...
  const PictureInPicture2 = createLucideIcon("PictureInPicture2", __iconNode$7C);
  ...
  const PictureInPicture = createLucideIcon("PictureInPicture", __iconNode$7B);
  ...
  const PilcrowRight = createLucideIcon("PilcrowRight", __iconNode$7z);
  ...
  const PilcrowLeft = createLucideIcon("PilcrowLeft", __iconNode$7y);
  ...
  const PocketKnife = createLucideIcon("PocketKnife", __iconNode$7i);
  ...
  const PointerOff = createLucideIcon("PointerOff", __iconNode$7e);
  ...
  const Rabbit = createLucideIcon("Rabbit", __iconNode$6$);
  ...
  const Radar = createLucideIcon("Radar", __iconNode$6_);
  ...
  const Radio = createLucideIcon("Radio", __iconNode$6W);
  ...
  const Radius = createLucideIcon("Radius", __iconNode$6V);
  ...
  const RadioTower = createLucideIcon("RadioTower", __iconNode$6U);
  ...
  const Rainbow = createLucideIcon("Rainbow", __iconNode$6T);
  ...
  const RailSymbol = createLucideIcon("RailSymbol", __iconNode$6S);
  ...
  const Reply = createLucideIcon("Reply", __iconNode$6m);

  const __iconNode$6l = [
    ["polygon", { points: "11 19 2 12 11 5 11 19", key: "14yba5" }],
    ["polygon", { points: "22 19 13 12 22 5 22 19", key: "1pi1cj" }]
  ];
  const Rewind = createLucideIcon("Rewind", __iconNode$6l);
  ...
  const Scale3d = createLucideIcon("Scale3d", __iconNode$5V);
  ...
  const Share2 = createLucideIcon("Share2", __iconNode$5k);
  ...
  const ShipWheel = createLucideIcon("ShipWheel", __iconNode$54);
  ...
  const ShoppingBasket = createLucideIcon("ShoppingBasket", __iconNode$51);
  ...
  const ShoppingCart = createLucideIcon("ShoppingCart", __iconNode$50);
  ...
  const SlidersHorizontal = createLucideIcon("SlidersHorizontal", __iconNode$4G);
  ...
  const SlidersVertical = createLucideIcon("SlidersVertical", __iconNode$4F);
  ...
  const SmilePlus = createLucideIcon("SmilePlus", __iconNode$4B);
  ...
  const SquareMousePointer = createLucideIcon("SquareMousePointer", __iconNode$3K);
  ...
  const SquareParkingOff = createLucideIcon("SquareParkingOff", __iconNode$3J);
  ...
  const SquareRoundCorner = createLucideIcon("SquareRoundCorner", __iconNode$3A);
  ...
  const SquareScissors = createLucideIcon("SquareScissors", __iconNode$3z);

  const __iconNode$3y = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M16 8.9V7H8l4 5-4 5h8v-1.9", key: "9nih0i" }]
  ];
  const SquareSigma = createLucideIcon("SquareSigma", __iconNode$3y);

  const __iconNode$3x = [
    ["path", { d: "M7 12h2l2 5 2-10h4", key: "1fxv6h" }],
    ["rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", key: "h1oib" }]
  ];
  const SquareRadical = createLucideIcon("SquareRadical", __iconNode$3x);

  const __iconNode$3w = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["line", { x1: "9", x2: "15", y1: "15", y2: "9", key: "1dfufj" }]
  ];
  const SquareSlash = createLucideIcon("SquareSlash", __iconNode$3w);
  ...
  const StickyNote = createLucideIcon("StickyNote", __iconNode$3c);
  ...
  const SwatchBook = createLucideIcon("SwatchBook", __iconNode$2_);
  ...
  const TableColumnsSplit = createLucideIcon("TableColumnsSplit", __iconNode$2S);
  ...
  const TableCellsSplit = createLucideIcon("TableCellsSplit", __iconNode$2R);
  ...
  const TestTubeDiagonal = createLucideIcon("TestTubeDiagonal", __iconNode$2y);
  ...
  const Tent = createLucideIcon("Tent", __iconNode$2x);

  const __iconNode$2w = [
    ["polyline", { points: "4 17 10 11 4 5", key: "akl6gq" }],
    ["line", { x1: "12", x2: "20", y1: "19", y2: "19", key: "q2wloq" }]
  ];
  const Terminal = createLucideIcon("Terminal", __iconNode$2w);
  ...
  const TestTubes = createLucideIcon("TestTubes", __iconNode$2v);
  ...
  const TestTube = createLucideIcon("TestTube", __iconNode$2u);
  ...
  const ThermometerSun = createLucideIcon("ThermometerSun", __iconNode$2k);
  ...
  const Toilet = createLucideIcon("Toilet", __iconNode$24);

  const __iconNode$23 = [
    ["rect", { width: "20", height: "12", x: "2", y: "6", rx: "6", ry: "6", key: "f2vt7d" }],
    ["circle", { cx: "16", cy: "12", r: "2", key: "4ma0v8" }]
  ];
  const ToggleRight = createLucideIcon("ToggleRight", __iconNode$23);
  ...
  const Trash2 = createLucideIcon("Trash2", __iconNode$1R);
  ...
  const TreePalm = createLucideIcon("TreePalm", __iconNode$1O);
  ...
  const TreePine = createLucideIcon("TreePine", __iconNode$1N);
  ...
  const TrendingUp = createLucideIcon("TrendingUp", __iconNode$1J);
  ...
  const TrendingUpDown = createLucideIcon("TrendingUpDown", __iconNode$1I);
  ...
  const TriangleRight = createLucideIcon("TriangleRight", __iconNode$1G);
  ...
  const TriangleDashed = createLucideIcon("TriangleDashed", __iconNode$1F);
  ...
  const UserPen = createLucideIcon("UserPen", __iconNode$1c);
  ...
  const UserMinus = createLucideIcon("UserMinus", __iconNode$1b);
  ...
  const VideoOff = createLucideIcon("VideoOff", __iconNode$N);
  ...
  const View = createLucideIcon("View", __iconNode$J);
  ...
  const WebhookOff = createLucideIcon("WebhookOff", __iconNode$p);
  ...
  const Wind = createLucideIcon("Wind", __iconNode$d);
  ...
  const WindArrowDown = createLucideIcon("WindArrowDown", __iconNode$c);
  ...
  const Worm = createLucideIcon("Worm", __iconNode$9);
  ...
  const ZapOff = createLucideIcon("ZapOff", __iconNode$3);
  ...
  const ZoomOut = createLucideIcon("ZoomOut", __iconNode$1);
  ...
  const ZoomIn = createLucideIcon("ZoomIn", __iconNode);
