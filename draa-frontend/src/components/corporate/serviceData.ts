...
export const services: ServiceDetail[] = [
  ...
  {
    number: '06',
    slug: 'study-in-india-guidance',
    aliases: ['study-in-india', 'study-india'],
    themeColor: '#059669',
    themeGradient: 'linear-gradient(135deg, #059669 0%, #047857 100%)',
    title: 'Study in India Strategic Guidance',
    shortTitle: 'Study in India Guidance',
    eyebrow: 'CORE BUSINESS ACTIVITY',
    summary: 'Comprehensive academic guidance for international students: university matching, scholarship advisory, eligibility evaluation, and admission pathway support.',
    intro: 'DRAA operates a dedicated guidance and advisory portal helping international students navigate Indian higher education. We connect global learners with accredited universities, explain eligibility and equivalence, and streamline admission milestones.',
    image: '/brand/corporate/stock/delhi_university_heritage_hd.jpg',
    imageAlt: 'International students walking across a premier Indian university heritage campus',
    icon: 'landmark',
    proof: [
      { value: 'Accredited', label: 'NAAC A+ & NIRF Ranked' },
      { value: 'End-to-End', label: 'Eligibility to Arrival' },
      { value: 'Scholarship', label: 'SII & Financial Guidance' },
    ],
    bulletPoints: [
      'International student university & course discovery',
      'Academic eligibility, grade conversion, and equivalence evaluation',
      'Scholarship advisory, fee structures, and financial planning',
      'Application preparation, document checklist, and submission tracking',
      'Visa, FRRO registration, and campus arrival advisory',
      'Institutional partnerships with premier Indian universities',
    ],
    capabilities: [
      { text: 'International student university & course discovery', icon: 'search' },
      { text: 'Academic eligibility, grade conversion, and equivalence evaluation', icon: 'clipboard' },
      { text: 'Scholarship advisory, fee structures, and financial planning', icon: 'lightbulb' },
      { text: 'Application preparation, document checklist, and submission tracking', icon: 'check' },
      { text: 'Visa, FRRO registration, and campus arrival advisory', icon: 'shield' },
      { text: 'Institutional partnerships with premier Indian universities', icon: 'building' },
    ],
    challenges: [
      { title: 'Complex admission procedures', description: 'We provide clear, step-by-step milestone checklists for international learners.', icon: 'search' },
      { title: 'Equivalence & grade conversion confusion', description: 'AIU equivalence guidance and structured document verification ensure smooth eligibility validation.', icon: 'clipboard' },
      { title: 'Navigating scholarships & fees', description: 'Transparent breakdowns of tuition fees, Study in India scholarships, and living costs.', icon: 'lightbulb' },
      { title: 'Visa and arrival uncertainty', description: 'Pre-departure roadmaps covering Student Visa application, FRRO compliance, and campus arrival.', icon: 'shield' },
    ],
    deliverables: [
      { title: 'University & Course Matching', description: 'Personalized recommendations across NIRF/NAAC accredited Indian universities based on career ambitions.', icon: 'search', image: '/brand/corporate/stock/delhi_university_heritage_hd.jpg' },
      { title: 'Eligibility & Equivalence Advisory', description: 'Document evaluation, AIU equivalence guidance, and credential verification checklists.', icon: 'clipboard', image: '/brand/corporate/stock/home_content_publishing.jpg' },
      { title: 'Scholarship & Fee Advisory', description: 'Guidance on Government of India SII scholarships, institutional waivers, and payment methods.', icon: 'lightbulb', image: '/brand/corporate/stock/career_counseling_session.jpg' },
      { title: 'Application & Admission Support', description: 'End-to-end guidance from preliminary application submission to receiving official offer letters.', icon: 'check', image: '/brand/corporate/stock/student_skill_workshop.jpg' },
      { title: 'Visa & Departure Roadmap', description: 'Comprehensive assistance for Student Visa documentation, FRRO registration, and travel prep.', icon: 'shield', image: '/brand/corporate/stock/corporate_training_room.jpg' },
      { title: 'Dedicated Guidance Portal', description: 'Direct access to the DRAA Study in India digital guidance platform with self-assessment tools.', icon: 'laptop', image: '/brand/corporate/stock/web_dev_mockup.jpg' },
    ],
    process: [
      { title: 'Discover', description: 'Explore top courses, rankings, and accredited universities.' },
      { title: 'Evaluate', description: 'Review academic eligibility, equivalence, and document checklists.' },
      { title: 'Apply', description: 'Submit applications through verified institutional channels.' },
      { title: 'Arrive', description: 'Complete visa formalities, travel to campus, and begin studies.' },
    ],
    outcomes: ['Transparent admission pathways', 'Higher scholarship discovery', 'Stress-free visa processing', 'Seamless campus integration'],
    audiences: ['International Students', 'Foreign Education Boards', 'Indian Universities & Colleges', 'Educational Counselors'],
  },
];
