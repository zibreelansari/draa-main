...
export const corporatePages: Record<string, CorporatePageData> = {
  ...
  capabilities: {
    slug: 'capabilities', navigationLabel: 'Services', eyebrow: 'Our services',
    title: 'Services that educate — Outcomes that matter',
    summary: 'Engage DRAA for one specialist service or combine capabilities into a complete educational programme.',
    seo: { title: 'DRAA Services', description: 'Explore DRAA services in content, training, events, advisory and digital experiences.' },
    sections: [
      { key: 'services', eyebrow: 'What we do', title: 'Five services — One accountable partner', description: 'Each service is planned for the audience, delivery context and desired learning outcome.', layout: 'feature-grid', items: [
        { title: 'Content & Curriculum Development', description: 'Research-led books, digital publications, courseware, assessments and custom learning resources.', icon: 'book', link: '/services/content-publishing' },
        { title: 'Training & Capacity Building', description: 'Faculty development, student skills, leadership and career-readiness programmes.', icon: 'graduation', link: '/services/professional-learning' },
        { title: 'Events & Conferences', description: 'Conferences, seminars, webinars and knowledge-sharing programmes from concept to delivery.', icon: 'calendar', link: '/services/education-events' },
        { title: 'Advisory & Institutional Solutions', description: 'Curriculum planning, programme development, institutional improvement and training strategy.', icon: 'briefcase', link: '/services/academic-advisory' },
        { title: 'Digital Experiences & Platforms', description: 'Online course design, learner journeys, assessments and learning-platform support.', icon: 'laptop', link: '/services/digital-learning' },
      ] },
