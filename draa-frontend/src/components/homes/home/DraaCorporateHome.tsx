          ...
          <div className="draa-corp-shell draa-corp-hero-inner">
            <div className="draa-corp-hero-copy">
              ...
              <div className="draa-corp-trust-row">
                ...
                <i />
                <div><strong>Outcome-led</strong><span>Teaching, tutoring &amp; training</span></div>
                <i />
                <div><strong>End-to-end</strong><span>Ideas, delivery &amp; impact</span></div>
              </div>
            </div>
            ...
            <div className="draa-corp-hero-visual" aria-label="DRAA's five education capabilities">
              ...
              <div className="draa-corp-visual-brand">
                ...
                <strong>DRAA</strong>
                <span>Education Services<br />&amp; Knowledge Management</span>
              </div>
              <div className="draa-corp-capability capability-one"><BookOpen size={17} /> Content</div>
              <div className="draa-corp-capability capability-two"><GraduationCap size={17} /> Training</div>
              <div className="draa-corp-capability capability-three"><CalendarDays size={17} /> Events</div>
              <div className="draa-corp-capability capability-four"><Handshake size={17} /> Advisory</div>
        ...
        <section id="about" className="draa-corp-section draa-corp-about">
          <div className="draa-corp-shell draa-corp-two-column">
            ...
            <div className="draa-corp-about-copy">
              ...
              <p>Our role is simple: understand the educational challenge, design the right intervention and remain accountable for the quality of the outcome.</p>
              <div className="draa-corp-about-points">
                <span><CheckCircle2 size={17} /> Research-led</span>
                <span><CheckCircle2 size={17} /> Institution-ready</span>
                <span><CheckCircle2 size={17} /> Learner-centred</span>
              </div>
              <div className="draa-corp-delivery-visual" aria-label="DRAA delivery approach">
                <div><span><Search size={17} /></span><strong>Discover</strong><small>Understand the need</small></div>
                <i aria-hidden="true" />
                <div><span><Lightbulb size={17} /></span><strong>Design</strong><small>Shape the solution</small></div>
                <i aria-hidden="true" />
                <div><span><Presentation size={17} /></span><strong>Deliver</strong><small>Put learning into action</small></div>
                <i aria-hidden="true" />
                <div><span><CheckCircle2 size={17} /></span><strong>Improve</strong><small>Review the outcome</small></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="solutions" className="draa-corp-section draa-corp-solutions">
          <div className="draa-corp-shell">
            ...
            <div className="draa-corp-solution-grid">
              {solutions.map(({ number, icon: Icon, title, text, tags }) => (
                <article key={title} className="draa-corp-solution-card">
        ...
        <section id="study-in-india" className="draa-corp-section draa-corp-study">
          <div className="draa-corp-shell draa-corp-study-card">
            ...
            <div id="study-tools" className="draa-corp-study-tools">
              <div><Search size={20} /><span><strong>Discover</strong>Courses &amp; institutions</span></div>
              <div><ClipboardCheck size={20} /><span><strong>Prepare</strong>Eligibility &amp; documents</span></div>
              <div><Lightbulb size={20} /><span><strong>Explore</strong>Scholarship guidance</span></div>
              <div><ShieldCheck size={20} /><span><strong>Navigate</strong>Visa &amp; FRRO steps</span></div>
            </div>
          </div>
        </section>
        ...
        <section id="partner" className="draa-corp-partner">
          <div className="draa-corp-shell draa-corp-partner-inner">
            <div>
              ...
              <p>Let’s shape the content, programme, event or digital solution that moves your learners and institution forward.</p>
            </div>
            <Link to="/contact" className="draa-corp-button draa-corp-button-light">Start a conversation <ArrowRight size={18} /></Link>
          </div>
        </section>
      </main>
